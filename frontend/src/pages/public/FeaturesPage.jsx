...
const features = [
  {
    ...
    description:
      "Track prospective students from first contact to admission with 12 predefined stages.",
    highlights: [
      "Auto-assignment",
      "Bulk reassignment",
      "Timeline tracking",
  ...
  },
  {
    ...
    description:
      "Customize the student registration process to match your university's requirements.",
    highlights: [
      "6 configurable steps",
      "Enable/disable features",
      "Course-wise settings",
  ...
  },
  {
    ...
    description:
      "Collect registration fees seamlessly with Razorpay integration.",
    highlights: [
      "Direct payouts",
      "Refund processing",
  ...
  },
  {
    ...
    description:
      "Automated email communications throughout the admission journey.",
    highlights: [
      "Welcome emails",
      "Status updates",
      "Payment receipts",
      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">
            ...
            <span className="text-blue-600">Modern Admissions</span>
          </h1>
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
            A complete suite of tools designed to streamline your admission
