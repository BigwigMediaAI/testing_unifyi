      ...
      <section className="py-20 bg-gradient-to-b from-slate-50 to-white dark:from-slate-900 dark:to-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">
            About <span className="text-blue-600">UNIFYI</span>
          </h1>
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
            We're on a mission to transform how universities manage their
            admission process, making it seamless for institutions and students
            alike.
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  To provide universities with a comprehensive, intelligent
                  platform that simplifies the entire admission journey—from
                  lead generation to enrollment. We believe technology should
                  empower educators, not complicate their work.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-8">
                ...
                <p className="text-slate-600 dark:text-slate-400 leading-relaxed">
                  To become the leading admission management platform trusted by
                  universities worldwide, setting the standard for efficiency,
                  transparency, and student experience in higher education
                  admissions.
                </p>
              </CardContent>
            </Card>
      ...
      <section className="py-16">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
            Our team combines deep expertise in education technology with a
            passion for improving the admission experience. We work closely with
            universities to understand their challenges and build solutions that
