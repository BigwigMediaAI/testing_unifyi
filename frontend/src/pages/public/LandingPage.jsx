...
const features = [
  {
    ...
    description:
      "Track and manage prospective students from first contact to admission with intelligent lead scoring.",
  },
  {
    icon: FileText,
    title: "Configurable Workflows",
    description:
      "Customize registration steps for each university - documents, tests, payments, and more.",
  },
  {
    icon: ClipboardCheck,
    title: "Online Entrance Tests",
    description:
      "Built-in MCQ-based entrance testing with randomization, instant results, and analytics.",
  },
  {
    icon: CreditCard,
    title: "Integrated Payments",
    description:
      "Collect registration fees seamlessly with automatic university payouts via Razorpay.",
  },
  {
    icon: Building2,
    title: "Multi-Tenant Platform",
    description:
      "One platform, unlimited universities. Complete data isolation and customization.",
  },
  {
    icon: BarChart3,
    title: "Real-Time Analytics",
    description:
      "Track admissions, conversions, and counsellor performance with comprehensive dashboards.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-left">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-slate-900 dark:text-white mb-6">
                Unifyi Your <span className="text-blue-600">Admission</span>{" "}
                Process
              </h1>

              <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-8 leading-relaxed max-w-xl">
                The complete SaaS platform for universities to manage leads,
                applications, counselling, entrance tests, and payments—all in
                one place.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
              A comprehensive platform designed for universities that want to
              streamline their admission process.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white mb-6">
                Why Universities Choose UNIFYI
              </h2>
                ...
                {[
                  {
                    ...
                    desc: "Keep 100% of your registration fees. We only charge a flat subscription.",
                  },
                  {
                    icon: Shield,
                    title: "Secure & Compliant",
                    desc: "Enterprise-grade security with complete data isolation between universities.",
                  },
                  {
                    icon: Globe,
                    title: "Scalable Infrastructure",
                    desc: "Handle thousands of concurrent applications without breaking a sweat.",
                  },
                ].map((item, index) => (
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join leading universities already using UNIFYI to streamline their
            admissions.
          </p>
