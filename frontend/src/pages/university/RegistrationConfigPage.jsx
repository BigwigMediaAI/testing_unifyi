...
export default function RegistrationConfigPage() {
  ...
  const loadConfig = async () => {
    try {
      ...
      if (regConfig.discount) {
        setDiscountEnabled(regConfig.discount.is_enabled ?? false);
        setDiscountType(regConfig.discount.discount_type || "fixed");
      ...
      if (
        regConfig.required_documents &&
        regConfig.required_documents.length > 0
      ) {
      ...
      <div className="space-y-6" data-testid="registration-config-page">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-1">
              Configure your student registration workflow
            </p>
          </div>
          <Button
            onClick={handleSave}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Enable or disable steps in the student registration workflow
            </CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Select
                    value={testEligibility}
                    onValueChange={setTestEligibility}
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="after_registration">
                        After Basic Registration
                      </SelectItem>
                      <SelectItem value="after_documents">
                        After Document Upload
                      </SelectItem>
                      <SelectItem value="after_payment">
                        After Fee Payment
                      </SelectItem>
                    </SelectContent>
                  </Select>
                  <p className="text-sm text-slate-500">
                    When can students take the entrance test?
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={paymentStage} onValueChange={setPaymentStage}>
                    ...
                    <SelectContent>
                      <SelectItem value="after_application">
                        After Application
                      </SelectItem>
                      <SelectItem value="after_documents">
                        After Documents
                      </SelectItem>
                      <SelectItem value="after_test">
                        After Entrance Test
                      </SelectItem>
                    </SelectContent>
                  </Select>
                ...
                <div className="flex items-center justify-between p-4 rounded-lg border border-slate-200 dark:border-slate-800">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Enable refund requests for registration fee
                    </p>
                  </div>
                  <Switch
              ...
              <div className="mt-6 border-t pt-6 space-y-4">
                <div className="flex items-center justify-between p-4 rounded-lg border border-slate-200 dark:border-slate-800">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Offer discount on registration fee
                    </p>
                  </div>
                  <Switch
        ...
        {documentsEnabled && (
          <Card data-testid="documents-config-card">
            <CardHeader>
              ...
              <CardDescription>
                Configure documents required from students
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
