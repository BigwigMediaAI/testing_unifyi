...
export default function StudentDashboard() {
  ...
  const isApplicationSubmitted = currentApplication?.status === "submitted";
  return (
    <StudentLayout>
      <div className="space-y-8" data-testid="student-dashboard">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
          ...
          <p className="text-blue-100 text-lg">
            {registrationConfig?.university_name || "Your university"} -
            Application Portal
          </p>
          {currentApplication && (
            <div className="mt-6">
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <CardDescription>
                    Application No: {currentApplication.application_number}
                  </CardDescription>
                </div>
                <Badge
                  className={
                    APPLICATION_STATUS[currentApplication.status]?.color ||
                    "bg-slate-100"
                  }
                >
                  {APPLICATION_STATUS[currentApplication.status]?.label ||
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        <p
                          className={`font-medium ${completed ? "text-green-700 dark:text-green-400" : current ? "text-blue-700 dark:text-blue-400" : "text-slate-700 dark:text-slate-300"}`}
                        >
                          {step.name}
                        </p>
                      ...
                      {current && !isApplicationSubmitted && (
                        <Button
          ...
          <Card>
            <CardContent className="p-8 text-center">
              ...
              <p className="text-slate-600 dark:text-slate-400 mb-4">
                You don't have any active application. Start your application
                now.
              </p>
              <Button
                className="bg-blue-600 hover:bg-blue-700"
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Card
            className="hover:border-blue-500/50 cursor-pointer transition-colors"
          ...
          <Card
            className="hover:border-blue-500/50 cursor-pointer transition-colors"
            onClick={() => navigate("/student/institution")}
          >
            <CardContent className="p-6 flex items-center gap-4">
