        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <span className="font-bold text-blue-600">UNIFYI</span>
                ...
                <Card>
                  ...
                  <CardContent>
                    {currentQuestion.question_type === "single_choice" ? (
                      <RadioGroup
                        value={
                          responses[currentQuestion.id]?.[0]?.toString() || ""
                        }
                        onValueChange={(val) =>
                          handleOptionSelect(
                            currentQuestion.id,
                          ...
                          {currentQuestion.options?.map((option, idx) => (
                            <div
                              ...
                              className={`flex items-center space-x-3 p-3 rounded-lg border cursor-pointer hover:bg-slate-50 dark:hover:bg-slate-800 ${
                                responses[currentQuestion.id]?.includes(idx)
                      ...
                      <div className="space-y-3">
                        {currentQuestion.options?.map((option, idx) => (
                          <div
                            ...
                            onClick={() =>
                              handleOptionSelect(currentQuestion.id, idx, true)
                            }
                            data-testid={`option-${idx}`}
                          >
                            <Checkbox
